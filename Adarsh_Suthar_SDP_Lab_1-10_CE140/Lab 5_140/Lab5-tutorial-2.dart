//import 'package:lab-5-tutorial-2/lab-5-tutorial-2.dart' as lab-5-tutorial-2;
...
void main(List<String> arguments) {
  ...
  final adarsh = Student("Adarsh", "Suthar");
  final jessie = SchoolBandMember('Jessie', 'Jones');
  final marty = StudentAthlete('Marty', 'McFly');
  print(jon.fullName);
  print(adarsh.fullName);
  final historyGrade = Grade.B;
  jon.grades.add(historyGrade);
  final students = [adarsh, jessie, marty];
